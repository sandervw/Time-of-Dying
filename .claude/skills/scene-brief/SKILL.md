...
- **`## Premise`** — one paragraph: a brief, single-paragraph premise of the larger story, distilled from the source material.
- **`## Scene Structure`** — POV, tense, target wordcount
...
Everything in the brief **except the scene outline** must fit in **30%** of the combined wordcount of all supplementary source material (including words from any material in `PRIMARY_PATH` not directly part of the scene), OR **600 words**, whichever is smaller.
