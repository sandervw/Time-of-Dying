...
$reminder = @"
Reminder before writing/editing this markdown: would the text benefit from specific proper names or setting context? If yes:
...
This is a soft nudge, not a hard rule. Skip if the content is purely structural/meta (config, index, todo, etc.).
"@
