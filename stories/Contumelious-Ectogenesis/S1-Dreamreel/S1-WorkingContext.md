# Dreamreel - Working Context

**NOTE FOR LLMS:** this document represents the full allowable context to be used when writing content for a story. Only this text, any files referenced here, and your own memory, may be read as context during the writing. DO NOT read any other files unless explicitly told to by the user.

Explicitly Allowed files:
- `/setting/` and subfolders/files
- `/setting/sampling.py` (for any vocabulary/conventions)
...
**5. The Scriptorium.** They breach a library of rotted codices. Othelmedir retrieves a treatise on dream-draughts he helped author decades ago. He does not say so.

**6. The Still-Room.** In the alchemy wing they brew a death-vision draught. Only the untethered can drink it safely. Weirmoth qualifies.
...
## The Tower of the Attercop

Thick with cobwebs (dreamcatchers) and spider