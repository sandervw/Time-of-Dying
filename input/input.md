...
- @stories\The-CCK\The-Hypnotist-of-Yellowmoor.md
- @stories\The-CCK\The-Tower-of-Silence.md
- @stories\The-CCK\The-Old-Soulwood.md

Each agent should put its extracted lore in a distinct file in the @output\ folder. Questions?

---

Hey claude, I need you to incorporate the new lore in @output\The-Old-Soulwood-lore-extraction.md into the existing lore in @setting\ . This is all new or modified lore for the main mythology.md file, the main folklore.md, and the specific mythology and folklore subfolders.
