...
Provides an incantation for creating related or dependent undead without specifying their concrete type (e.g., an EvilUndeadFactory, a GoodUndeadFactory, a SentientUndeadFactory).

### Constructors

Build complex undead by separating formation and representation (e.g., a ToeToScalpConstructor, an EssenceCollectionConstructor, a FromDustToLivingFleshConstructor, a BloodSacrificeConstructor).

Creating a complicated undead creature directly within a spell is inflexible. It commits the spell to creating a particular type of undead and makes it impossible to change the type later independently from (without having to change) the spell.
...
Restricts summoned undead to one specific soul or not-soul.

## Desire Motifs (Structural)

Desire Motifs concern undead capability. They define ways of creating undead with new or enhanced functionality.

### Attunements

Allows a spell which imparts certain abilities to impart other abilities instead (e.g., changing strength to speed; changing undead sight to sight-through-undead, etc.).
...
- **Golems** -- Wax, Glass, or Leather. Cannot be created under the sky or sun.
