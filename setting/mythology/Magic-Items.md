# Magic Items and Sundries

## Overview

Necromantic tools, substances, reagents, and curios. Some are crafted deliberately; others grow in the cursed landscape or are byproducts of spellwork. A working mancer's field kit typically includes flints, a shovel, a steel basinet, and whatever reagents the job demands.
...
- Stored in a shiny apple-shaped bottle; contents taste and look like metal
- Grants mirror-like skin as a permanent curse that persists after death
- Implies necromantic curses can be administered through substances, not only spoken Deadspeech

### Hasodeki's Crucible

- A clay kiln that functions as a portal to a hidden chamber, activated by a spoken word ("Bindweed")
- Demonstrates that portal enchantments exist, use verbal triggers, and can be disguised as mundane objects
